  ...
  return (
    <div
      style={{
        ...
        height: "100vh",
        overflowY: "auto",
        backgroundColor: "#f4f7fa", // Lighter background
      }}
    >
      ...
      <Modal
        ...
        destroyOnClose
        width="100%"
        style={{ maxWidth: "600px" }} // Max width for modal
        className="user-modal" // Optional, if you'd like to add custom class for modal styling
      >
